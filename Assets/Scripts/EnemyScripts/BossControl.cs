...
public class BossControl : MonoBehaviour
{
	...
	void GetStateControl()
	{
		...
		{
			print("TODO boss control boss state is dead");
		...
		{
			print("TODO boss control boss state is pause");
			...
			{
				print("TODO boss control boss state is attack");
                ...
                if (currentAttackTime >= waitAttackTime)
                {
                    ...
                    //todo anim.SetInteger("Atk", atkRange);
				...
				bossStateChecker.BossState = Boss_State.PAUSE;
